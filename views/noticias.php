...
=======
            <li class="breadcrumb-item active" aria-current="page"><a class="link-dark"
                    style="text-decoration: none;">Noticias</a>
...
<div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
        <span class="bg-secondary pr-3">Noticias destacadas</span>
    </h2>
    <div class="row px-xl-5">
            ...
            <div class="product-item bg-light mb-4">
                ...
                <div class="text-center py-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center mt-2">
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of
                            the card's
                            content.<br>yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy<br>vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv<br>fffffffffffffffffffffffffffffffffff<br>ccccccccccccccccccccccccccccccc<br>cccccccccccccccccccccccccccccccccc<br>cccccccccccccccccccccccccccccccccccccccccccv<br>fffffffffffffffffffffffffffff<br>dddddddddddddddefreertyhtghtddddddddddddddddd<br>
                        </p>
>>>>>>> 47d5b32a02406c643e6f2216ee8a7b757cf3fa39
                    </div>
                </div>
